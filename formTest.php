    ...
    <div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333;">
      ...
      <div align="left">
        ...
        <div align="right">
          ...
          <input type="hidden" name="teacher" value="<?php
      ...
      <?php elseif( $page_flag === 2 ):
        ...
        $result = mysql_query("INSERT INTO peppers(date, time, name,text,teacher) VALUES('$date', '$time', '$name', '$text','$teacher')", $con);
        if (!$result) {
          exit('データを登録できませんでした。');
        }
        ...
        <?php else:?>
          ...
          <form method="post" action="">
            <div class="element_wrap">
              ...
              <!-- <input type="text" name="teacher" value="" required>	 -->
            </div>
