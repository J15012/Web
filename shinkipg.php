<?php
 ...
 echo "ユーザID：".$_SESSION["TEACHER_ID"];
 ?><br>
   ...
   <div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333;">
     ...
     <div align="left">
       ...
       <div align="right">
         ...
         <input type="hidden" name="teacher_id" value="<?php
         if(!isset($_SESSION["TEACHER_ID"])){
           header("Location:login.html");
           exit;
         }
     ...
     <?php elseif( $page_flag === 2 ):
       ...
       $result = mysql_query("INSERT INTO peppers(date, time, name,text,teacher_id) VALUES('$date', '$time', '$name', '$text','$teacher_id')", $con);
       if (!$result) {
         exit('データを登録できませんでした。');
       }
       $con = mysql_close($con);
       ...
       <?php else:?>
         ...
         <form method="post" action="">
           <div class="element_wrap">
             ...
             <!-- <input type="text" name="teacher_id" value="" required>	 -->
           </div>
